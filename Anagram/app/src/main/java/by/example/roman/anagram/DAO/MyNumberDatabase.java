...
public class MyNumberDatabase extends SQLiteAssetHelper {

    private static final String DATABASE_NAME = "numericQuestionDB.sqlite";
    private static final int DATABASE_VERSION = 1;

    public MyNumberDatabase(Context context) {
